...
CreateGameResponse createGameResponseFromJson(String str) =>
    CreateGameResponse.fromJson(json.decode(str));

String createGameResponseToJson(CreateGameResponse data) =>
