...
class SelectPlayTimeListWidget extends StatefulWidget {
  // final int pos;
...
class _ListViewInWrapState extends State<SelectPlayTimeListWidget> {
  ...
  void initState() {
    super.initState();
    for (int i = 0; i < Strings.playingTimeList.length; i++) {
